...
class Episode(BaseModel):
    ...
    airdate: Optional[str] = Field(None, description="播出日期，格式: YYYY-MM-DD")
    name: str = Field(..., description="剧集日文名称")
    name_cn: str = Field(..., description="剧集中文名称")
    duration: Optional[str] = Field(None, description="时长，格式: HH:MM:SS")
    ...
    duration_seconds: Optional[int] = Field(None, description="时长(秒)", ge=0)
