...
[![version](https://img.shields.io/badge/version-v2.0.4-blue.svg)](https://github.com/united-pooh/astrbot_plugin_bangumi)
...
| `user_agent` | `AstrBot-Bangumi-Plugin/v2.0.4 ...` | Bangumi API User-Agent；空值自动回退默认值 |
...
```text
dist/astrbot_plugin_bangumi_enhance-v2.0.4.zip
```
